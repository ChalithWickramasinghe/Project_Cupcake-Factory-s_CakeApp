...
{
    public static final String APP_NAME="CakeShop";
    public static final String Key_Name="User_Name";
    public static final String Admin_Key_Name="Admin_User_Name";
    public static final String Key_Email="Email";
    public static final String Key_PIN="PIN";
    public static final String Admin_Key_PIN="Admin_PIN";
